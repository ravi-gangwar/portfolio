    ...
    return (
        <div className='mt-10 select-none'>
            ...
            <div className='flex w-full items-center'>
                <p className='hidden text-gray-400 mt-5 pr-20 text-1xl lg:flex lg:flex-wrap max-w-xl leading-relaxed'>
                    My goal is to
...
function Heading({ text, align = 'left', className }: HeadingProps) {
    return (
        <h1 className={`dark:text-zinc-50 text-6xl mt-2 font-semibold sm:text-8xl lg:text-7xl xl:text-9xl 2xl:text-[200px] 2xl:tracking-widest ${align === 'right' ? 'text-right' : 'text-left'} ${className}`}>
            {text}
        </h1>
    )
}
